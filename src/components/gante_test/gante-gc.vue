    ...
    <div @scroll="ganteview_scroll" class="ganteview">
      <div :style="{width:header_width+'px'}" class="ganteview-header" >
        <div class="ganteview-toptime">
          <div class="ganteview-headercell" :title="item.date" v-for="item in top_time_data" :key="item.index" :style="{width:item.width+'px',left:item.left+'px'}">{{item.date}}</div>
        </div>
        <div class="ganteview-bottomtime">
          <div class="ganteview-headercell" :title="item.title" v-for="item in bottom_time_data" :key="item.index" :style="{width:item.width+'px',left:item.left+'px'}">{{item.date}}</div>
        </div>
      </div>
      <gante-gc-item :th_data="th_data" :style="{width:header_width+'px'}" v-if="show_item" class="ganteview-content-box" :gante_data="gante_data" >
        <div v-for="item in bottom_time_data" :key="item.index" class="ganteview-column" :style="{width:item.width+'px',left:item.left+'px',background:item.is_rest?'#f5f7fa':null}"></div>
      </gante-gc-item>
    </div>
  </div>
</template>

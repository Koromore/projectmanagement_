    ...
    <el-row>
      ...
      <el-col :span="24" class="table table1" v-if="table_show">
        <el-col :span="24" class="title">
          <el-col :span="3">所属项目<i class="el-icon-caret-bottom"></i></el-col>
          <el-col :span="3">部门<i class="el-icon-caret-bottom"></i></el-col>
          <el-col :span="3">任务</el-col>
          <el-col :span="3">执行状态<i class="el-icon-caret-bottom"></i></el-col>
